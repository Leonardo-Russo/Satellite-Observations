...
function [mjd, mjdfrac] = mjday(yr, mon, day, hr, min, sec)
        ...
        mjd = 367.0 * yr  ...
             ...
             + floor( 275 * mon / 9.0 ) ...
             + day - 678987.0;
        mjdfrac = (sec + min * 60.0 + hr *3600.0) / 86400.0;
        
        % check jdfrac
        if mjdfrac > 1.0 
            mjd = mjd + floor(mjdfrac);
            mjdfrac = mjdfrac - floor(mjdfrac);
        end
